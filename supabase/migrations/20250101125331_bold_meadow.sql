/*
  # Fix appointment booking and availability

  1. Changes
    - Fix timezone handling for appointments and availability
...
-- Improved doctor availability check
...
-- Improved appointment slot validation
...
-- Recreate the appointment validation trigger
...
-- Recreate the announcements trigger
