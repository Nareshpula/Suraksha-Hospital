/*
  # Fix SMS API Integration
  
  1. Update SMS functions to use new Fast2SMS API format
  2. Add proper error handling and logging
  3. Fix CORS issues by using Supabase functions
*/
...
BEGIN
  ...
  IF p_type = 'otp' THEN
    -- For OTP messages, use variables_values
